...
train_aug_strat_gen = 'TAandStyle50alpha10' #TrivialAugmentWide, RandAugment, AutoAugment, AugMix
loss = 'CrossEntropyLoss'
lossparams = {'label_smoothing': 0.1}
trades_loss = True
trades_lossparams = {'step_size': 0.1, 'epsilon': 0.1, 'perturb_steps': 1, 'beta': 1.0, 'distance': 'l_2'}
robust_loss = False
...
autoattack_params = {'setsize': 1000, 'epsilon': 0.5, 'norm': 'L2'}
